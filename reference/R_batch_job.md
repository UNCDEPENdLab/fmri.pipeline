...
- [`batch_job$new()`](#method-batch_job-initialize)

- [`batch_job$generate()`](#method-batch_job-generate)

- [`batch_job$submit()`](#method-batch_job-submit)

- [`batch_job$copy()`](#method-batch_job-copy)

- [`batch_job$reset_file_names()`](#method-batch_job-reset_file_names)

- [`batch_job$get_job_id()`](#method-batch_job-get_job_id)

- [`batch_job$get_child_ids()`](#method-batch_job-get_child_ids)

- [`batch_job$clone()`](#method-batch_job-clone)
...
#### Usage
    ...
    batch_job$generate(force = FALSE)
