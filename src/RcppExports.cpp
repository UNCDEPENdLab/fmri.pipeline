...
// do_convolve
arma::vec do_convolve(const arma::vec& input, const arma::vec& kernel, const int phase, const bool renorm);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool >::type renorm(renormSEXP);
