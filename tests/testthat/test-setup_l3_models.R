...
test_that("test finalize_pipeline_configuration", {
  ...
  # gpa$l1_model_setup$fsl$l1_model_setup
  # gpa$l2_model_setup$fsl$feat_complete
  
  # # running setup_l3_models
  # # setup_l3_models dont run since it checks if feat_inputs <- gpa$l1_model_setup$fsl %>% dplyr::filter(feat_complete == TRUE)
  ...
  load("/proj/mnhallqlab/users/nidhi/fmri.pipeline_testing/gpa_tests_build_l1_models/scheduler_scripts/batch_87dc8b58-39cd-4956-85a7-9c59485aa2fd/run_pipeline_cache.RData")
