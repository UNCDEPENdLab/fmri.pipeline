#' test build_l3_models function
test_that("test build_l3_models", {
  ...
  expect_equal(length(unique(gpa$l3_models$models$age$metadata$id)), 10)
  expect_equal(nrow(gpa$l3_models$models$age$model_data), 10)
