...
#' @param l1_confound_files optional first-level confound files.
...
#' @param nvoxels approximate number of voxels per run.
#' @param execute_feat whether to execute FEAT after writing files.
#'
